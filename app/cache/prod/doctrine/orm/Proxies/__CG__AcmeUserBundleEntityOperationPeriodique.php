 ...
 */
class OperationPeriodique extends \Acme\UserBundle\Entity\OperationPeriodique implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'date', 'compte', 'type', 'montant', 'operationBancaire');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OperationPeriodique $proxy) {
    ...
    public function addOperationBancaire(\Acme\UserBundle\Entity\OperationBancaire $operationBancaire)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addOperationBancaire', array($operationBancaire));

        return parent::addOperationBancaire($operationBancaire);
    }
    ...
    public function removeOperationBancaire(\Acme\UserBundle\Entity\OperationBancaire $operationBancaire)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeOperationBancaire', array($operationBancaire));

        return parent::removeOperationBancaire($operationBancaire);
    }
    ...
    public function getOperationBancaire()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOperationBancaire', array());

        return parent::getOperationBancaire();
    }
